...
public class BlackJack {
        ...
        if(!cpu){
            while(true){
                ...
                if(res.equals("HIT") || res.equals("H")){
                    ...
                    System.out.println("There's only so much you can do in Blackjack, that is not one of them");
                }
            }
        }else {
            while(true){
    ...
    private void showmsg(String win){
        switch (win.toUpperCase()) {
            case "WIN" -> System.out.println("You have won the round!");
            case "LOSE" -> System.out.println("You have lost the round, better luck next time!");
            case "PUSH" -> System.out.println("You have tied this round.");
            case "BLACKJACK" -> System.out.println("Blackjack! You have won the round!");
        }
    }
